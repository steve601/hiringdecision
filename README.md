...
## Overview
->Pedicting whether an applicant will be hired or not based on some entities.
...
1. **Clone the repository**:
    ```sh
    git clone https://github.com/steve601/hiringdecision.git
    cd hiringdecision
    ```
...
**Upload Application Code:**
    ...
    Place the code in a suitable directory, e.g., /home/ec2-user/hiring-decision
